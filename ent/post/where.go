...
// Crabrave applies equality check predicate on the "crabrave" field. It's identical to CrabraveEQ.
func Crabrave(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCrabrave), v))
	})
}
...
// CrabraveEQ applies the EQ predicate on the "crabrave" field.
func CrabraveEQ(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldCrabrave), v))
	})
}

// CrabraveNEQ applies the NEQ predicate on the "crabrave" field.
func CrabraveNEQ(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldCrabrave), v))
	})
}

// CrabraveIn applies the In predicate on the "crabrave" field.
func CrabraveIn(vs ...int) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Post(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldCrabrave), v...))
	})
}

// CrabraveNotIn applies the NotIn predicate on the "crabrave" field.
func CrabraveNotIn(vs ...int) predicate.Post {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Post(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldCrabrave), v...))
	})
}

// CrabraveGT applies the GT predicate on the "crabrave" field.
func CrabraveGT(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldCrabrave), v))
	})
}

// CrabraveGTE applies the GTE predicate on the "crabrave" field.
func CrabraveGTE(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldCrabrave), v))
	})
}

// CrabraveLT applies the LT predicate on the "crabrave" field.
func CrabraveLT(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldCrabrave), v))
	})
}

// CrabraveLTE applies the LTE predicate on the "crabrave" field.
func CrabraveLTE(v int) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldCrabrave), v))
	})
}
