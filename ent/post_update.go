...
func (pu *PostUpdate) SetCrabrave(i int) *PostUpdate {
	pu.mutation.ResetCrabrave()
	pu.mutation.SetCrabrave(i)
	return pu
}

// SetNillableCrabrave sets the "crabrave" field if the given value is not nil.
func (pu *PostUpdate) SetNillableCrabrave(i *int) *PostUpdate {
	if i != nil {
		pu.SetCrabrave(*i)
	}
	return pu
...
func (pu *PostUpdate) AddCrabrave(i int) *PostUpdate {
	pu.mutation.AddCrabrave(i)
	return pu
}
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Crabrave(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
	...
	if value, ok := pu.mutation.AddedCrabrave(); ok {
...
// SetCrabrave sets the "crabrave" field.
func (puo *PostUpdateOne) SetCrabrave(i int) *PostUpdateOne {
	puo.mutation.ResetCrabrave()
	puo.mutation.SetCrabrave(i)
	return puo
}

// SetNillableCrabrave sets the "crabrave" field if the given value is not nil.
func (puo *PostUpdateOne) SetNillableCrabrave(i *int) *PostUpdateOne {
	if i != nil {
		puo.SetCrabrave(*i)
	}
	return puo
...
// AddCrabrave adds i to the "crabrave" field.
func (puo *PostUpdateOne) AddCrabrave(i int) *PostUpdateOne {
	puo.mutation.AddCrabrave(i)
	return puo
}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if value, ok := puo.mutation.Crabrave(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: post.FieldCrabrave,
	...
	if value, ok := puo.mutation.AddedCrabrave(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
			Column: post.FieldCrabrave,
